...
//check expected exception,invocationtimeout and invocationcount.

public class TestNgBasics10 {
    @BeforeSuite //1
    public void setUp() {
...
//    }
    @Test(invocationTimeOut = 2) //5
    public void titleTest() {
//        System.out.println("@titleTest0 -  check title of yor app");
        while(true){
            System.out.println("Hello");
        }
    }

//    @Test(invocationCount = 4) //5
//    public void titleTest2() {
//        System.out.println("@titleTest0 -  check title of yor app");
//    }

    @Test(expectedExceptions = ArithmeticException.class) //5
