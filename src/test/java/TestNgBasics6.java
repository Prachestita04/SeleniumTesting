...
//check execution flow after giving two test annotation without using @BeforeMethod and @AfterMethod annotation.
...
//    }
    ...
    public void titleTest(){
        System.out.println("@titleTest -  check title of yor app");
    }
    @Test
    public void nextTestMethod(){
        System.out.println("@nextTestMethod - Check next new condition in your app");
    }
//    @AfterMethod //6
//    public void logout(){
