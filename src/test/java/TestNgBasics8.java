...
//check execution flow after giving many test annotation and mention some priority in that - output shown according to priority .
...
public class TestNgBasics8 {
    ...
    public void titleTest(){
        System.out.println("@titleTest1 and p3 -  check title of yor app");
    }
    @Test(priority = 1)
    public void titleTest2(){
        System.out.println("@titleTest2 and p1 -  check title of yor app");
    }
    @Test
    public void titleTest3(){
        System.out.println("@titleTest3 and p0 by default-  check title of yor app");
    }
    @Test(priority = 2)
    public void titleTest4(){
        System.out.println("@titleTest4 and p2 -  check title of yor app");
    }
    @AfterMethod //6
    public void logout(){
